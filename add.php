...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Vehicle Emission</a></li>
          </ul>
        </li>
    ...
    <section class="content">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Task', 'Hours per Day'],
          ['Carbon Count',     <?php  $query = mysql_query("SELECT Carbon FROM emit_comp");
                                                    ...
                                                    echo $carbon; ?>],
          ['Nitrogen Component',      <?php  $query = mysql_query("SELECT Nitrogen FROM emit_comp");

                                                    while ($rows = mysql_fetch_array($query)) {
                                                      $nitrogen = $rows["Nitrogen"];
                                                    }
                                                    

                                                    echo $nitrogen; ?>],
          ['Oxides of Nitrogen',  <?php  $query = mysql_query("SELECT OxidesOfNitrogen FROM emit_comp");

                                                    while ($rows = mysql_fetch_array($query)) {
                                                      $Oxides = $rows["OxidesOfNitrogen"];
                                                    }
 ...
 <form name="submit" action="update-notif.php" method="POST">
       <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-aqua">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">dddd</span>
        ...
        <!--  nexxxxxxxxxxxxttttttttttttttttt-->
       ...
       <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-red">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Carbon Count</span>
              <span class="info-box-number"><input type="text" class="form-control" placeholder="Enter a Number" name="Carbon" id="Carbon"  required value="<?php echo $carbon; ?>">
              </span>
       ...
       <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Nitrogen Count</span>
              <span class="info-box-number"><input type="text" class="form-control" placeholder="Enter a Number" name="Nitrogen" id="HydroCarbon" required value="<?php echo $nitrogen; ?>">
              </span>
       ...
       <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-orange">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Oxides of Nitrogen</span>
              <span class="info-box-number"><input type="text" class="form-control" placeholder="Enter a Number" name="OxidesOfNitrogen" id="OxidesOfNitrogen" required value="<?php echo $Oxides; ?>"></span>
            ...
            <div class="places-buttons">
                            <div class="row">
                                <div class="col-md-2 col-md-offset-4">
                                    <button type="submit" name="submit" value="Submit" class="btn btn-info btn-block">UPDATE</button>
                                </div>
