...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
            ...
            mysql_select_db('db-air');

                //building permit
                $Carbon= $_POST['Carbon'];
                $Nitrogen  = $_POST['Nitrogen'];
                $OxidesOfNitrogen = $_POST['OxidesOfNitrogen'];
               

                $query = " UPDATE emit_comp SET Carbon = '$Carbon',Nitrogen = '$Nitrogen',OxidesOfNitrogen = '$OxidesOfNitrogen'";
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="content">
                                <div class="header">
                                    <h4 class="title text-center">Data has been moved to archive.<br>
                                </div>
                                <hr>
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-2 col-md-offset-4">
                                            <a href="index.php" class="btn btn-info btn-block"><i class="fa fa-archive"></i>     DASHBOARD</a>
                                        </div>
                                        <div class="col-md-2 col-md-offset-0">
                                            <a href="add.php" class="btn btn-info btn-block"><i class="fa fa-database"></i>   EDIT DATA</a>
                                        </div>
                                    </div>
                                </div>
                            </div>    
