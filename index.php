       ...
       <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-red">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php  $query = mysql_query("SELECT Carbon FROM emit_comp");
       ...
       <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php  $query = mysql_query("SELECT Nitrogen FROM emit_comp");
       ...
       <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-orange">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php  $query = mysql_query("SELECT OxidesOfNitrogen FROM emit_comp");
